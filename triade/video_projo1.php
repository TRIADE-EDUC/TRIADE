...
<img src="video-proj-moy-matiere.php?saisie_eleve=<?php print $_GET["saisie_eleve"]?>&saisie_classe=<?php print $_GET["saisie_classe"]?>&trimestre=<?php print $_GET["trimestre"]?>" name="main" width="100%" height="180" /><br><br><i>Double-cliquer sur l'image pour la redimensionner.</i>
