...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' ><?php print "Liste des relevés de non absence, ni retard" ?></font></b></td></tr>
<tr id='cadreCentral0' >
<td ><br><br>
     <!-- // fin  -->
<form method=post name=formulaire target="_blank" action="liste_abs_rtd_aucun2.php">
