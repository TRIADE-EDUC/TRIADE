...
for($j=$dep;$j<$nbEleveT;$j++) {  // premiere ligne de la creation PDF
	...
	$photo="./image/banniere/banniere-ismapp2.jpg";
	$pdf->Image($photo,10,15,60,30);

	$pdf->SetTextColor(24,37,140);

	$pdf->SetFont('Arial','B',9);
	$pdf->SetXY(80,$ycoor0);
	$pdf->MultiCell(100,3,"Cycle $anneeScolaire",0,'R',0);

	$pdf->SetFont('Arial','B',12);
	$pdf->SetFillColor(255);
	$pdf->SetXY(80,$ycoor0+10);
	$pdf->MultiCell(100,3,"RELEVE DE NOTES ET RESULTATS",0,'R',0);	
	$pdf->SetXY(80,$ycoor0+20);
	$pdf->MultiCell(120,3,"Cycle Langue, Civilisation et histoire politique française",0,'c',0);	


	$pdf->SetFont('Arial','B',11);
	$pdf->SetXY(10,$ycoor0+40);
	$pdf->MultiCell(100,3,"Etudiant(e) : $prenomEleve $nomEleve",0,'L',0);
	$pdf->SetXY(10,$ycoor0+45);
