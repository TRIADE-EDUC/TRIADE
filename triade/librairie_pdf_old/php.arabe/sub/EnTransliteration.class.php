...
{
    protected static $_arRegPatterns = array('/^ال/','/^إِي/','/^عِي/','/^عُو/','/ْع$/', 
                                       '/ِي$/','/َو$/','/َي$/','/^ع/','/^أ/','/^آ/'         );
    protected static $_arRegReplacements = array('Al-', 'ei', 'ei', 'ou', 'a',
                                           'i', 'aw', 'ay', 'a', 'a', 'aa');
        
    protected static $_arPatterns = array('ّ', 'تة', 'ته', 'كة', 'كه', 'ده', 'دة', 'ضه', 'ضة', 'سه', 'سة', 'صه', 'صة',
    ...
    protected static $_arReplacements = array('#', "t'h", "t'h", "k'h", "k'h", "d'h", "d'h", "d'h", "d'h", "s'h", "s'h", "s'h", "s'h",
    ...
    protected static $_arFinePatterns = array("/'+/", "/([\- ])'/", '/(.)#/');
    protected static $_arFineReplacements = array("'", '\\1', "\\1'\\1");
