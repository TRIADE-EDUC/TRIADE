...
class ArStrToTime
{
    protected static $_hj = array('محرم', 'صفر', 'ربيع الأول', 'ربيع الثاني', 'جمادى الأولى', 'جمادى الثانية',
                               'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعدة', 'ذو الحجة');
    
    protected static $_patterns = array('أ', 'إ', 'آ', 'ة', 'بعد', 'تالي', 'لاحق', 'قادم', 'سابق', 'فائت',
    ...
    protected static $_replacements = array('ا', 'ا', 'ا', 'ه', 'next', 'next', 'next', 'next', 'last', 'last',
