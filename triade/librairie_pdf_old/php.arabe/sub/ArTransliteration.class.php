...
{
    protected static $_enRegPatterns = array('/^au/', '/^a/', '/^e/', '/^i/', '/^mc/', '/^o/', '/^u/', '/^wr/', '/ough$/', '/ue$/', '/a$/', '/s$/');
    protected static $_enRegReplacements = array('ا', 'ا', 'ا', 'ا', 'ماك', 'او', 'ا', 'ر', 'ه', '', 'ه', 'س');
            
    protected static $_enPatterns = array('ough', 'alk', 'ois', 'sch', 'tio', 'ai', 'au', 'bb', 'cc', 'ce', 
    ...
    protected static $_enReplacements = array('او', 'وك', 'وا', 'ش', 'ش', 'اي', 'او', 'ب', 'ك', 'س', 
