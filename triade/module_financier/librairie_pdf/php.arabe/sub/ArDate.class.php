...
{
    protected $_mode = 1;
    protected static $_ISLAMIC_EPOCH = 1948439.5;
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _hjConvert($Y, $M, $D)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _jdToIslamic($jd)
    {
        $jd = (int)$jd + 0.5;
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _islamicToJd($year, $month, $day)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _gregToJd ($m, $d, $y)
    {
        if ($m > 2) {
            $m = $m - 3;
        } else {
