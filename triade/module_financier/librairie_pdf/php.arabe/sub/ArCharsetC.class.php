...
class ArCharsetC
{
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _getHTML($index)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _getUTF($index)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _findUTF($char)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _getWIN($index)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _findWIN($char)
    {
        if (!$char) return false;
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _getISO($index)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    protected function _findISO($char)
    {
        if (!$char) return false;
