...
if(autorisation_module()) {
	...
	if($operation == 'rechercher') {
		...
		//$sql .= "WHERE ec.date_echeance <= '" . date_vers_bdd($date_limite) . "' AND ec.date_echeance >= '2016-01-01' ";
		$sql .= "WHERE ec.date_echeance <= '" . date_vers_bdd($date_limite) . "' AND ec.date_echeance >= '" . date("Y", strtotime("-1 year")) . "-01-01' ";
