...
if ($membre == "menuprof") {
  ...
  if ($PUBLIC && $ztFrom == "profil" && $ztAction == "INSERT") {
    ...
    if ($rdTelephone != "N") $rdTelephone = "O";
    $rsProfil['util_telephone_vf'] = $rdTelephone;
    $rsProfil['util_planning'] = $zlPlanning+0;
    if ($rdPartage=="2" && empty($ztPartage)) $rdPartage = "0";
    $rsProfil['util_partage_planning'] = $rdPartage+0;
    $rsProfil['util_email'] = $ztEmail;
    if (($zlAffectation=="2" && empty($ztPartage)) || ($zlAffectation=="3" && empty($ztAffecte))) $zlAffectation = "0";
    ...
    if ($zlPrecision!="2") $zlPrecision = "1";
