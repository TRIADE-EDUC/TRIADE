...
<?php } ?>
INPUT.Texte, TEXTAREA, SELECT<?php echo (preg_match("/MSIE/", $navigateur)) ? ", .Saisie" : ""; ?> {
  FONT-FAMILY: Verdana, Arial, Helvetica;
  FONT-SIZE: 10px;
...
INPUT.Texte:hover, TEXTAREA:hover, SELECT:hover<?php echo (preg_match("/MSIE/", $navigateur)) ? ", .SaisieHover" : ""; ?> {
  FONT-FAMILY: Verdana, Arial, Helvetica;
  FONT-SIZE: 10px;
...
INPUT.Case  {
  WIDTH: 14px;
  HEIGHT: 14px;
  VERTICAL-ALIGN: <?php echo (preg_match("/MSIE/", $navigateur)) ? "baseline" : "middle"; ?>; /* IE ou Firefox */
}
INPUT.Bouton  {
  FONT-FAMILY: Verdana, Arial, Helvetica;
  FONT-SIZE: 10px;
...
INPUT.Bouton:hover<?php echo (preg_match("/MSIE/", $navigateur)) ? ", INPUT.BoutonHover" : ""; ?> {
  FONT-FAMILY: Verdana, Arial, Helvetica;
  FONT-SIZE: 10px;
  FONT-WEIGHT: bold;
...
INPUT.PickList:hover<?php echo (preg_match("/MSIE/", $navigateur)) ? ", INPUT.PickListHover" : ""; ?> {
  FONT-FAMILY: Verdana, Arial, Helvetica;
  FONT-SIZE: 9px;
  FONT-WEIGHT: bold;
  COLOR: <?php echo (isset($FormulaireTexteBoutonHover) && !empty($FormulaireTexteBoutonHover)) ? $FormulaireTexteBoutonHover : $FormulaireTexteBouton; ?>;
