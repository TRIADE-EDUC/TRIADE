...
// FIN Mise en place des moyenens general partiel et periode
	...
	$pdf->SetFont('Arial','',8);
	if ($nbheureabs > 4) {
		$nbabsplus=$nbheureabs/4;
		list($nbabsplus,$minuteplus)=preg_split('/\./',$nbabsplus);
		$nbabs+=$nbabsplus;
		$nbheureabs=$minuteplus/60;
		$nbheureabs=number_format($nbheureabs,'0','','');
	}
...
$commentairedirection=stripslashes($commentairedirection);
