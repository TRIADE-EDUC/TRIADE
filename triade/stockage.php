...
// verif repertoire //
if (!is_dir("./data/stockage")) { mkdir("./data/stockage");  }
if (!is_dir("./data/stockage/".$_SESSION['membre'])) { mkdir("./data/stockage/".$_SESSION['membre']); }
...
$auth_users = array(
    'admin' => '$2y$10$dJn8lziSBnxUPWG.3/lCEOzXfBH147Zert5bi6yz84y1oiL1zsbwK', 
    'user' => '$2y$10$dJn8lziSBnxUPWG.3/lCEOzXfBH147Zert5bi6yz84y1oiL1zsbwK' 
);
...
// e.g. 'txt,html,css,js'
$allowed_file_extensions = 'gif,png,jpg,html,txt,pdf,doc,docx,xls,xlsx';

// Allowed file extensions for upload files
// e.g. 'gif,png,jpg,html,txt'
$allowed_upload_extensions = 'gif,png,jpg,html,txt,pdf,doc,docx,xls,xlsx';
...
if ( !defined( 'FM_SESSION_ID')) {
    define('FM_SESSION_ID', 'filemanagertriade');
}
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
			<a class="nav-link active" href="" ><i class="fa fa-arrow-circle-o-up"></i><?php echo lng('Partage') ?></a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
...
if (isset($_GET['view'])) {
    ...
    $file_img = $diruser . fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $file);
    $file_path = $path . '/' . $file;
        ...
        <div class="col-12">
            ...
            if($is_onlineViewer) {
                ...
                if (in_array($ext, array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))) {
                    echo '<p><img src="visu_image_stockage.php?idpers='.$_SESSION['id_pers'].'&fic=' . $file_img . '" alt="image" class="preview-img-container" class="preview-img"></p>';
                }
            } elseif ($is_audio) {
                // Audio content
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            foreach ($files as $f) {
			   ...
			   <?php $imagePreview = fm_enc("./visu_image_stockage.php?idpers=".$_SESSION['id_pers']."&fic=$diruser". (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f); ?>
			...
			if (($_SESSION["membre"] == "menuadmin") || ($_SESSION["membre"] == "menuprof") || ($_SESSION["membre"] == "menuscolaire")) { ?>
                        <a title="<?php echo lng('Partage') ?>" href="stockage-partage-fichier.php?fic=<?php echo urlencode($f) ?>&amp;fichier=<?php echo urlencode($f) ?>" ><i class="fa fa-share"></i></a>
			<?php } ?>
                    </td>
                </tr>
                <?php
...
<style>
.btn {
   color:<?php print $colorA ?> ; 
   border-color:<?php print $colorA?>
}
.btn:hover {
    background-color: <?php print $colorA ?>;
    border-color: <?php print $colorA ?> ;
    color:white;
}
</style>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand"> <?php echo lng('TRIADE-BOX') ?> </a>
