...
<!-- // fin  -->
<blockquote><BR>
<font class=T2><?php print LANGRESA16?> :</font> <input type=text name="saisie_creat_classe" size=30  maxlength=15  value="<?php print stripslashes($libelle) ?>"  ><BR>
<BR><bR>
<font class=T2><?php print LANGRESA18?> :</font> <input type=text name="saisie_info" size=25  value="<?php print stripslashes($info) ?>"  ><BR>
<BR><bR>
