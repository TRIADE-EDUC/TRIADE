...
</object></td> <td valign='top'><br> <a href='#'  onMouseOver="AffBulle('<?php print LANGTMESS475 ?> : <?php print $taille ?>');"  onMouseOut="HideBulle()";><img src="./image/help.gif" border=0 align=center></a>
-->
