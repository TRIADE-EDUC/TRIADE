...
if (LAN == "oui") {
	...
	if (!file_exists("../common/config-sign.php")) {
		...
		print "<form method='post' action='sign-inscription.php'  >";
		print "<input type='hidden' name=productid value='".$productid."'   >";
		print "<ul><br /><font class=T2>";
		print "Vous n'avez aucun compte de créé pour la gestion  TRIADE-SIGN.";
		print "<br /><br />";
		...
		$idkey=SIGNKEY;
		$inc=GRAPH;
		print "<table align=center><tr><td><font class=T2>Acc&egrave;s &agrave; votre compte TRIADE-SIGN : </font></td>";
		print "<td><script language=JavaScript>buttonMagicSubmit3('Cliquez ICI','https://www.triade-educ.org/accueil/triade-sign-compte.php?idkey=$idkey&inc=$inc','_blank','','','');</script></td></tr></table>";
	}

	include_once("../common/config2.inc.php");
	if (AFFICHAGESIGN != "oui") {
		print "<ul><br /><font class=T2 color='red' >";
                print "Vous devez activer l'autorisation d'utilisation de TRIADE-SIGN dans la module <a href='configuration.php'><font color='red'><b>Config. G&eacute;n&eacute;rale.</b></font></a>";
                print "<br /><br />";
