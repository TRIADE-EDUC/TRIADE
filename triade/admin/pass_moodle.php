...
<tr id='coulBar0' ><td height="2"><b><font   id='menumodule1' >Mot de passe  Moodle</font></b></td></tr>
...
if (isset($_POST["create"])) {
	...
	$cnx=cnx();
	modifPasseAdminMoodle($_POST["pwd"]);
	print "<center><font class=T2>Mot de passe Moodle initialisé</font></center><br><br>";
	Pgclose($cnx);
}else{
?>
	<ul>
