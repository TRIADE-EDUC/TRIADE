...
if (!file_exists("./common/config-sms.php")) {
	...
	print "<iframe width='100%' height=500 src='https://support.triade-educ.org/support/ia-inscription.php?url=$url&inc=$graph&productid=$productid' MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 ></iframe>";
}else{
	print "<center><font class=T2>Votre &eacute;tablissement a &eacute;j&agrave; un compte d'inscrit au service TRIADE-COPILOT</font></center>";
