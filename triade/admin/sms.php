...
if (LAN == "oui") {
	if (!file_exists("../common/config-sms.php")) {
		...
		print "<td><script language=JavaScript>buttonMagicSubmit3('Cliquez ICI','https://www.triade-educ.org/accueil/sms-compte.php?idsms=$idsms&inc=100','_blank','','','');</script></td><td><script language=JavaScript>buttonMagicSubmit3('Réinitialiser votre compte SMS','sms-init.php','_self','','','');</script></td></tr></table>";
	}
}else{
