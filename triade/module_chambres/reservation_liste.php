							...
							<table cellspacing="1" cellpadding="3" border="0" bgcolor="#cccccc" width="100%">
								...
								?>
									<tr bgcolor="#ffffff">
										...
										<td align="left" valign="top" <?php echo $rowspan; ?> ><?php echo ucfirst($ligne["libelle"]); ?></td>
										<td align="left" valign="top" <?php echo $rowspan; ?> ><?php echo strtoupper($ligne["nom"]); ?></td>
										<td align="left" valign="top" <?php echo $rowspan; ?> ><?php echo ucfirst($ligne["prenom"]); ?></td>
									</tr>
								<?php
									}
								} else {
