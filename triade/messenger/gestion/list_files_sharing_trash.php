...
if ( _SHARE_FILES != '' )
{
  ...
  if ( $nb_row > 0 )
  {
    ...
    */
    ...
    while( list ($id_file, $fil_name, $fil_size, $fil_date, $fil_date_add, $fil_date_trash, $fil_nb_download, $fil_hash, $usrname_auth, $nickname_auth, $id_user_aut, $fpj_name, $id_group_dest, $fmd_name, $fil_compress, $fil_comment) = mysqli_fetch_row ($result) )
    {
      $row_num++;
