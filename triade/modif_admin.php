...
if(isset($_POST["create"])){
	// requete ? prenom2 ?
	$_POST["saisie_creat_nom"]=stripslashes(preg_replace("/'/"," ",$_POST["saisie_creat_nom"]));
	$_POST["saisie_creat_prenom"]=stripslashes(preg_replace("/'/"," ",$_POST["saisie_creat_prenom"]));
	...
	$saisie_id=$_GET["saisie_id"];
	  ...
	  $passage_argument="oui"; // pour le JavaScript
          ...
          $nom_admin=trim(stripslashes($data[0][1]));
          $prenom_admin=trim(stripslashes($data[0][2]));
          $passwd_admin=trim($data[0][3]);
          $intitule_admin=$data[0][4];
          $mail=trim($data[0][5]);
          $adr=trim(stripslashes($data[0][6]));
          $code_post=trim($data[0][7]);
          $commune=trim(stripslashes($data[0][8]));
	  $tel=trim($data[0][9]);
