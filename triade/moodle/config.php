...
$CFG->dbname    = DB;     // database name, eg moodle
$CFG->dbuser    = USER;   // your database username
$CFG->dbpass    = PWD;   // your database password
...
$CFG->wwwroot   = "http://".URLSITE.'moodle';
...
if (!is_dir(WEBROOT.'/'.ECOLE.'/moodledata')) mkdir (WEBROOT.'/'.ECOLE.'/moodledata');

$CFG->dataroot  = WEBROOT.'/'.ECOLE.'/moodledata';
