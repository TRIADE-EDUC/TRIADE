...
// +-------------------------------------------------+
// $Id: frbr_entity_common_datasource_aut_link.class.php,v 1.7 2019-04-19 12:28:25 ngantier Exp $
...
class frbr_entity_common_datasource_aut_link extends frbr_entity_common_datasource {
	...
	public function get_form(){
		...
		$selector = new marc_select("aut_link", "aut_link_type_parameter", $this->parameters->link_type, '', 0, $this->msg["frbr_entity_common_datasource_aut_link_all_links"]);
