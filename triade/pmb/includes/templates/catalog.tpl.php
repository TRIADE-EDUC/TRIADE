...
// +-------------------------------------------------+
// $Id: catalog.tpl.php,v 1.55 2019-05-27 16:19:33 btafforeau Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $categ, $mode, $sub, $quoi, $catalog_menu, $msg, $opac_avis_allow, $opac_allow_add_tag, $pmb_collstate_advanced, $z3950_accessible, $acquisition_active;
