...
// +-------------------------------------------------+
// $Id: apijsonrpc.class.php,v 1.12 2019-02-28 13:11:01 ngantier Exp $
...
class apijsonrpc extends connecteur_out {
	...
	public function get_running_pmb_userid($source_id) {
		...
		if (!empty($auth_user) && !empty($auth_pw)) {
		    ...
		    $this->json_input["auth_pw"] = md5($auth_user . $auth_pw . $sc->comment . $this->json_input["id"] . $this->json_input["method"]);
		}
