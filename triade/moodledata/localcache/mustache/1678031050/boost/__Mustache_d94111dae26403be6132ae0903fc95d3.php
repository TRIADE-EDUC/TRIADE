...
class __Mustache_d94111dae26403be6132ae0903fc95d3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block8add66eb6eca1504c3a94ef9e5537457'),
            ));
...
';
    ...
    public function block8add66eb6eca1504c3a94ef9e5537457($context)
    {
        $indent = $buffer = '';
