	...
	************************************************************************************************************/
	...
	var boxSizeArray = [20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20,20];	// Array indicating how many items there is rooom for in the right column ULs
	...
	*/
	function saveDragDropNodes()
	{
		...
		document.formulaire.donnee.value=saveString;
	...
	function initDragDropScript()
	{
		...
		for(var no=0;no<uls.length;no++){
			...
			uls[no].style.height = itemHeight * 3  + 'px';
		}
