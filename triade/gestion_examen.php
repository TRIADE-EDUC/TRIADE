...
<?php
filtreAnneeScolaireSelectNote($anneeScolaire,6);
?>
</select></td></tr>
</form>
...
<!-- 
<tr>
<form action='gestion_examen_brevet_nv.php'>
<td align=right><font class="T2"><?php print "Fiche Scolaire Brevet " ?> :</font></td>
