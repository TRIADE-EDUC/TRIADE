...
<tr>
<td bgcolor='yellow'>&nbsp;Taux horaire&nbsp;</td>
...
for ($i=0;$i<count($data);$i++){
	$creneaux=$data[$i][0]."#".timeForm($data[$i][1])."#".timeForm($data[$i][2]);
	print "<tr bgcolor='#FFFFFF' >";
	print "<td>&nbsp;".$data[$i][0]." ".$data[$i][1]."-".$data[$i][2]."&nbsp;</td>";
	print "<td align='center'>&nbsp;".nbabstotalTaux($creneaux)."&nbsp;</td>";
	print "<td align='center'>&nbsp;".nbretardtotalTaux($creneaux)."&nbsp;</td>";
	print "</tr>";
}
?>
</table>
